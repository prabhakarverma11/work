...
<nav class="navbar navbar-inverse">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		...
		<ul class="nav navbar-nav">
			<li id="idDropdownUser" class="dropdown"><a href="#"
				class="dropdown-toggle" data-toggle="dropdown"><i
					class="glyphicon glyphicon-user white"></i> User <b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li id="idDropdownAddUser"><a
						href="${pageContext.request.contextPath}/adduser"
						title="Add User"><i
							class="glyphicon glyphicon-plus-sign white"></i> Add User </a></li>
					<li id="idDropdownManageUser"><a
			...
			<li id="idDropdownReport" class="dropdown"><a href="#"
				...
				<ul class="dropdown-menu">
					<li id="idDropdownMenuCPReport"><a
						...
						<li id="idDropdownMenuKPReport"><a
							href="${pageContext.request.contextPath}/kpreport"
							title="Keywords Performance Report"><i
								class="glyphicon glyphicon-list-alt white"></i> Keywords
								Performance Report </a></li>
				</ul></li>
		</ul>
